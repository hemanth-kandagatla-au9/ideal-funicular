...
import { AxiosInstance } from '../../services/configService';
...
export const getTemplateDetails = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      // If payload exists (for restore case), include templateId and version in query
      const url = payload
        ? `/market-execution/getMarketPlaceTemplate?templateId=${payload.templateId}&version=${payload.version}&isRestore=true`
        : '/market-execution/getMarketPlaceTemplate';
