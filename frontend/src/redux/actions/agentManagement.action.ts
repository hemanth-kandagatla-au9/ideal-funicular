...
const startAgentService = (props: { hostname: string; port: string | number }) => ({
...
const syncAgentConfig = (props: { hostname: string; port: string } | { hostname: string; port: string }[]) => ({
  type: AGENT_MANAGEMENT.SYNC_AGENT_CONFIG,
  props,
});
const requestSyncAgentConfig = () => ({
  type: AGENT_MANAGEMENT.REQUEST_SYNC_AGENT_CONFIG,
});
const successSyncAgentConfig = (agentSyncConfig: string[]) => ({
  type: AGENT_MANAGEMENT.SUCCESS_SYNC_AGENT_CONFIG,
  successMessage: "Agent configuration sync triggered",
  agentSyncConfig,
});
const failureSyncAgentConfig = (error: { message: string }) => ({
  type: AGENT_MANAGEMENT.FAILURE_SYNC_AGENT_CONFIG,
  error: error.message || "",
});
...
const requestEnvUpgradeSelectedAgents = () => ({
  type: AGENT_MANAGEMENT.REQUEST_ENV_UPGRADE_SELECTED_AGENTS,
});
const successEnvUpgradeSelectedAgents = (output?: string) => ({
  type: AGENT_MANAGEMENT.SUCCESS_ENV_UPGRADE_SELECTED_AGENTS,
  successMessage: "The Selected Agent environment update triggered successfully",
});
const failureEnvUpgradeSelectedAgents = (error: { message: string }) => ({
...
const agentManagementActions = {
  ...
  syncAgentConfig,
  requestSyncAgentConfig,
  successSyncAgentConfig,
  failureSyncAgentConfig,
  ...
  envUpgradeSelectedAgents,
  requestEnvUpgradeSelectedAgents,
  successEnvUpgradeSelectedAgents,
  failureEnvUpgradeSelectedAgents,
