...
export default function agentManagementReducer(
  ...
  switch (action.type) {
    ...
    /* Fetch Agent Health Checkup By Port */
    ...
    /* Fetch Scheduler command data by id */
    ...
    /**
     * SELECTED AGENTS RESTART SERVICE
     */
    ...
    /**
     * SELECTED AGENTS HEALTHCHECK SERVICE
     */
    ...
    /**
     * SELECTED AGENTS UPGRADE SERVICE
     */
