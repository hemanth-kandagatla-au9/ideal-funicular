...
export default function agentManagementReducer(
  ...
  switch (action.type) {
    ...
    case AGENT_MANAGEMENT.SYNC_AGENT_CONFIG:
      return { ...state, filterLoading: true, agentSyncConfig: [] };
    case AGENT_MANAGEMENT.REQUEST_SYNC_AGENT_CONFIG:
      return { ...state, filterLoading: true, agentSyncConfig: [] };
    case AGENT_MANAGEMENT.SUCCESS_SYNC_AGENT_CONFIG:
      return { ...state, filterLoading: false, agentSyncConfig: action.agentSyncConfig };
    case AGENT_MANAGEMENT.FAILURE_SYNC_AGENT_CONFIG:
      return { ...state, filterLoading: false, error: action.error };
    ...
    case AGENT_MANAGEMENT.ENV_UPGRADE_SELECTED_AGENTS:
      return { ...state, serviceLoading: true, successMessage: "" };
    case AGENT_MANAGEMENT.REQUEST_ENV_UPGRADE_SELECTED_AGENTS:
      return { ...state, serviceLoading: true, successMessage: "" };
    case AGENT_MANAGEMENT.SUCCESS_ENV_UPGRADE_SELECTED_AGENTS:
      return { ...state, serviceLoading: false, successMessage: action.successMessage };
    case AGENT_MANAGEMENT.FAILURE_ENV_UPGRADE_SELECTED_AGENTS:
      return { ...state, serviceLoading: false, error: action.error };
