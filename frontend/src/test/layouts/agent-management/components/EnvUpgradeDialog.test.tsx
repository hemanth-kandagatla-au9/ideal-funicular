...
describe("EnvUpgradeDialog", () => {
  ...
  it("renders environment options", () => {
    render(
      <EnvUpgradeDialog showEnvUpgrade closeEnvUpgrade={jest.fn()} envUpgradeData={mockAgents} onConfirm={jest.fn()} />
    );
  ...
  it("shows error when no agents provided", () => {
    render(
      <EnvUpgradeDialog showEnvUpgrade closeEnvUpgrade={jest.fn()} envUpgradeData={[]} onConfirm={jest.fn()} />
    );
  ...
  it("calls onConfirm with selected env", () => {
    ...
    render(
      <EnvUpgradeDialog showEnvUpgrade closeEnvUpgrade={jest.fn()} envUpgradeData={mockAgents} onConfirm={onConfirm} />
    );
