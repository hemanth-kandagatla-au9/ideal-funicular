...
const BinaryVersions = () => {
  ...
  const [allVersionsForDropdown, setAllVersionsForDropdown] = useState<string[]>([]);
  ...
  const versionOptions = useMemo(() => allVersionsForDropdown, [allVersionsForDropdown]);
  ...
  }, [reduxResponse, filters.os.length, filters.versions.length, filters.types.length]);
  useEffect(() => {
