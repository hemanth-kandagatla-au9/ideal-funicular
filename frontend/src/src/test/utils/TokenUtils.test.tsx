...
describe("TokenUtils", () => {
  ...
  it("returns true when breakGlassEnabled is set in the token", () => {
    const token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJicmVha0dsYXNzRW5hYmxlZCI6dHJ1ZX0.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c";
    cookies.get.mockReturnValue(token);
