...
describe("UserService", () => {
  ...
  it("UserService getUsers SUCCESS", async () => {
    ...
    const payload = {
      filter: { name: "mock", group: "mock-group", isLoggedIn: true },
      pagination: {
        limit: 10,
        pageNo: 1,
      },
  ...
  it("UserService updateUser SUCCESS", async () => {
    const response = {
      data: {
        ...
        data: { user: { acknowledged: true, modifiedCount: 1, upsertedId: null, upsertedCount: 0, matchedCount: 1 } },
      },
    };
          ...
          usersActivityLog: [
            {
              ...
              sub: "702374717",
              name: "Kapil Patwal",
              memberOf: ["JJT-APP-RISE-DB-READONLY-NONPROD"],
              locale: "NA",
          ...
          usersActivityLog: [
            {
              ...
              Groups: ["JJT-APP-RISE-DEV", "JJT-APP-RISE-Developer", "JJT-APP-RISE-PREDEV", "JJT-APP-RISE-PROD", "JJT-APP-RISE-QA", "JJT-APP-RISE-SUPPORT-L3"],
              Locale: "NA",
  ...
  describe("getUsersActivityLogExport", () => {
    ...
    it("should handle error case", async () => {
      const errorResponse = {
        response: {
          data: {
            data: {
              // This matches the double-nested structure
              status: false,
      ...
      expect(result).toEqual({
        data: {
          data: {
            // Now matches the actual return structure
            status: false,
            message: "Error occurred",
          },
        },
    ...
    it("should include filter params in URL", async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith(`${get.usersActivityLog}/export?name=test&type=login`);
    });
  });
});
