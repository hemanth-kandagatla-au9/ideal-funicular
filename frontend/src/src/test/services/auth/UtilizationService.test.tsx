...
describe("UtilizationService", () => {
  ...
  describe("utilizationMetrics", () => {
    it("should post utilization metrics with correct parameters", async () => {
      ...
      expect(mockAxiosInstance.post).toHaveBeenCalledWith("http://test-api.com/v1/utilities/activity-log/", {
        activityType: type,
  ...
  describe("getUtilizationMetrics", () => {
    it("should fetch utilization metrics", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith("http://test-api.com/v1/utilities/activity-log/metrices");
  ...
  describe("getUtilizationMetricDetail", () => {
    it("should fetch metric details for specific activity", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith("http://test-api.com/v1/utilities/activity-log/metricedata?activity=LOGIN");
      expect(result).toEqual(mockResponse);
    });
  ...
  describe("getUtilizationMetricData", () => {
    it("should fetch metric data with all parameters", async () => {
      ...
      const expectedUrl =
        "http://test-api.com/v1/utilities/activity-log?limit=10&activityType=SEARCH&createDate=2023-01-01&action=ACTION&userID=USER&sid=SID&region=REGION&platform=PLATFORM&sector=SECTOR&pageNo=1";
    ...
    it("should handle exportData=true case", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith("http://test-api.com/v1/utilities/activity-log?exportData=true");
      expect(result).toEqual(mockResponse);
    });
  ...
  describe("getMetricsData", () => {
    it("should fetch metrics data", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith("http://test-api.com/metrics-data");
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe("getDownloadMetricsData", () => {
    it("should fetch download metrics data", async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith("http://test-api.com/download-metrics");
      expect(result).toEqual(mockResponse);
    });
  });
});
