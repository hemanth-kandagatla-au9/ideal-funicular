...
describe("AgentCardGrid Component", () => {
  ...
  test("renders cards after loading completes", () => {
    render(<AgentCardGrid agentMetricsTilesData={mockAgentMetricsTilesData} onSelectStatus={mockOnSelectStatus} />);
  ...
  test("applies correct styles when card is selected", () => {
    const Wrapper = () => {
      ...
      return <AgentCardGrid agentMetricsTilesData={mockAgentMetricsTilesData} onSelectStatus={setCurrentStatus} currentStatus={currentStatus} />;
    };
  ...
  test("handles empty array for agentMetricsTilesData", () => {
    render(<AgentCardGrid agentMetricsTilesData={[]} onSelectStatus={mockOnSelectStatus} />);
  ...
  test("renders skeleton loaders during initial loading", () => {
    render(<AgentCardGrid agentMetricsTilesData={null} onSelectStatus={mockOnSelectStatus} />);
