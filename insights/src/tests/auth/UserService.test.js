...
describe("UserService", () => {
  ...
  it("UserService getUsers SUCCESS 1", async () => {
    const response = {
      data:{
        "status": true,
        "statusCode": 200,
  ...
  it("UserService getUsers SUCCESS 2", async () => {
    const response = {
      data:{
        "status": true,
        "statusCode": 200,
  ...
  it("UserService getUsers FAILURE 1", async () => {
    const response = {
      response: {
        data: {
            "status": false,
  ...
  it("UserService getUser SUCCESS 3", async () => {
    const response = {
      data:{
        "status": true,
        "statusCode": 200,
  ...
  it("UserService getUser SUCCESS 4", async () => {
    const response = {
      data:{
        "status": true,
        "statusCode": 200,
  ...
  it("UserService getUser FAILURE 2", async () => {
    const response = {
      response: {
        data: {
            "status": false,
  ...
  it("UserService updateUser SUCCESS 5", async () => {
    const response = {
  ...
  it("UserService updateUser FAILURE 3", async () => {
    const response = {
      response: {
        data: "Fail",
      },
  ...
  it("UserService exportUsers SUCCESS 5", async () => {
    const response = {
      data:{
        "status": true,
        "statusCode": 200,
  ...
  it("UserService exportUsers FAILURE 3", async () => {
    const response = {
      response: {
        data: {
            "status": false,
  ...
  it("UserService exportUsers SUCCESS 6", async () => {
    const response = {
      data:{
        "status": true,
        "statusCode": 200,
  ...
  it("UserService exportUsers SUCCESS 7", async () => {
    const response = {
      data:{
        "status": true,
        "statusCode": 200,
